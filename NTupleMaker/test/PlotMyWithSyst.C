...
///////////////////////////////////////////////////////////////////////////////////////////////
	...
	if (Variable.Contains("phi")) h = CreateAxisHists(2, histData, -3, 3-0.01);
...

{
   ...
   if(Variable.Contains("puppi_phi") ){
         TVariable = "puppi_phi";
    }

    if(Variable.Contains("pfmet_phi_corr") ){
         TVariable = "pfmetcorr_phi";
    }
    if(Variable.Contains("pfmetcorr_phi_XY") ){
         TVariable = "pfmet_phi_XY";
    }
